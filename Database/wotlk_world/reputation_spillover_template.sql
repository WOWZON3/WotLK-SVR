...
-- Exportiere Struktur von Tabelle wotlk_world.reputation_spillover_template
...
-- Exportiere Daten aus Tabelle wotlk_world.reputation_spillover_template: 26 rows
