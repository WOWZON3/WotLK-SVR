...
REPLACE INTO `battleground_template` (`ID`, `MinPlayersPerTeam`, `MaxPlayersPerTeam`, `MinLvl`, `MaxLvl`, `AllianceStartLoc`, `AllianceStartO`, `HordeStartLoc`, `HordeStartO`, `StartMaxDist`, `Weight`, `ScriptName`, `Comment`) VALUES
	(1, 0, 40, 51, 80, 611, 3.16312, 610, 0.715504, 100, 1, '', 'Alterac Valley'),
	(2, 0, 10, 10, 80, 769, 3.14159, 770, 0.151581, 75, 1, '', 'Warsong Gulch'),
	(3, 0, 15, 20, 80, 890, 3.91571, 889, 0.813671, 75, 1, '', 'Arathi Basin'),
	(7, 0, 15, 61, 80, 1103, 3.03123, 1104, 0.055761, 75, 1, '', 'Eye of The Storm'),
	...
	(9, 0, 15, 71, 80, 1367, 0, 1368, 0, 0, 1, '', 'Strand of the Ancients'),
	(10, 0, 5, 10, 80, 1362, 0, 1363, 3.14159, 0, 1, '', 'Dalaran Sewers'),
	(11, 0, 5, 10, 80, 1364, 0, 1365, 0, 0, 1, '', 'The Ring of Valor'),
	(30, 0, 40, 71, 80, 1485, 0, 1486, 3.16124, 200, 1, '', 'Isle of Conquest'),
	(32, 0, 10, 1, 80, 0, 0, 0, 0, 0, 1, '', 'Random battleground');
