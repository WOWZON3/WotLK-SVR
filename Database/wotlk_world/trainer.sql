...
-- Exportiere Struktur von Tabelle wotlk_world.trainer
...
-- Exportiere Daten aus Tabelle wotlk_world.trainer: 130 rows
...
REPLACE INTO `trainer` (`Id`, `Type`, `Requirement`, `Greeting`, `VerifiedBuild`) VALUES
	...
	(125, 3, 0, '', 0),
	(95023, 3, 0, 'Can I teach you how to turn the meat you find on beasts into a feast?', 0),
	(95026, 2, 0, 'Seid gegrüßt!', 0),
	(95025, 2, 0, 'Seid gegrüßt!', 0),
	(95024, 2, 0, 'Seid gegrüßt!', 0),
	(95022, 2, 0, 'Seid gegrüßt!', 0);
