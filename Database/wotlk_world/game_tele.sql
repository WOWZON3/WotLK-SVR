...
-- Exportiere Struktur von Tabelle wotlk_world.game_tele
CREATE TABLE IF NOT EXISTS `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1446 DEFAULT CHARSET=utf8 COMMENT='Tele Command';

-- Exportiere Daten aus Tabelle wotlk_world.game_tele: 1.445 rows
...
REPLACE INTO `game_tele` (`id`, `position_x`, `position_y`, `position_z`, `orientation`, `map`, `name`) VALUES
	...
	(1433, -1848.36, -4094.62, 9.07558, 2.3301, 0, 'Gildenhaus01'),
	(1434, 2947.86, -3281.41, 157.711, 1.72603, 1, 'Waldeslied'),
	(1435, -77.1297, -4320.92, 158.403, 5.45902, 1, 'Ausblick01'),
	(1436, 841.973, -5567.42, 3.53091, 5.73867, 571, 'Dolchbucht'),
	(1437, 5471.59, -3725.62, 1593.44, 2.92209, 1, 'Hyjal'),
	(1438, -8623.69, 773.306, 96.6548, 0.735498, 0, 'Kathedralenplatz'),
	(1439, -10746, 322.636, 38.6745, 4.01218, 0, 'Rabenflucht'),
	(1440, -8803.55, 764.077, 96.3387, 3.28016, 0, 'humanfish'),
	(1441, -11388.4, 528.415, 171.12, 6.03503, 0, 'Lager01'),
	(1442, 2792.71, -1652.01, 16.5312, 2.3568, 571, 'Venturebucht'),
	(1443, 7647.74, 1070.32, 707.822, 3.15055, 571, 'OrgrimsHammer'),
	(1444, 7579.77, -6821.11, 86.3803, 5.53834, 530, 'tristessa'),
	(1445, 7553.8, -7673.1, 151.276, 0.361952, 530, 'Weltenwanderer');
