...
-- Exportiere Struktur von Tabelle wotlk_world.quest_request_items_locale
...
-- Exportiere Daten aus Tabelle wotlk_world.quest_request_items_locale: ~859 rows (ungefähr)
