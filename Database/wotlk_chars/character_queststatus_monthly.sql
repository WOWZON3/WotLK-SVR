...
-- Exportiere Struktur von Tabelle tc_characters.character_queststatus_monthly
...
-- Exportiere Daten aus Tabelle tc_characters.character_queststatus_monthly: ~0 rows (ungefähr)
