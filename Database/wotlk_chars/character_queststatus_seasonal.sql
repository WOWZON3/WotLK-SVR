...
-- Exportiere Struktur von Tabelle tc_characters.character_queststatus_seasonal
...
-- Exportiere Daten aus Tabelle tc_characters.character_queststatus_seasonal: ~0 rows (ungefähr)
