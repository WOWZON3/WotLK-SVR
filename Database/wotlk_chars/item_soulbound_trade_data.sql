...
-- Exportiere Struktur von Tabelle tc_characters.item_soulbound_trade_data
...
-- Exportiere Daten aus Tabelle tc_characters.item_soulbound_trade_data: ~0 rows (ungefähr)
