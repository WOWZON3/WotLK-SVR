...
-- Exportiere Struktur von Tabelle tc_characters.character_queststatus_rewarded
...
-- Exportiere Daten aus Tabelle tc_characters.character_queststatus_rewarded: ~0 rows (ungefähr)
